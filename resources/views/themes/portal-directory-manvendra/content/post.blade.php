            ...
            <div class="beener">
                <div class="row">
                    <div class=" col-lg-9 col-md-6 col-12">
                        ...
                        {{ $post->slug }} patient portal login page and full guide on how to access patient records on {{ $post->slug }} is listed here. You can visit the hospital official site {{ $post->slug }}, you can then book appointment, download lab tests report and check medical records from your patient portal at {{ $post->slug }}.
                    </div>
                    <div class="col-12 col-md-3">
                        <div class="cc">
                            @if (!empty($post->thumbnail))
                            <img class="img-fluid mt-2" src="https://s3.us-west-1.wasabisys.com/{{ config('filesystems.disks.wasabi.bucket') }}/scrape/thumbnail/{{ $post->thumbnail }}">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class=" col-lg-4 col-md-6 col-12">
                            <div class="state-sec">
                                ...
                                <p class="p-alexa"><span><i class="fa fa-check blog-bgstate" aria-hidden="true"></i></span>&nbsp; Alexa Rank:&nbsp;<span class="span-alexa"> {{ optional($post->attributes_relation)->alexa_rank ?? ""
                                        }}</span>
                                </p>
                                <hr>
                                <p class="p-alexa"><span><i class="fa fa-check blog-bgstate" aria-hidden="true"></i></span>&nbsp; Popular in Country:&nbsp;<span class="span-alexa"> {{ optional($post->attributes_relation)->alexa_country ?? ""
                                        }}</span>
                                </p>
                                <hr>
                                <p class="p-alexa"><span><i class="fa fa-check blog-bgstate" aria-hidden="true"></i></span>&nbsp; Country Alexa Rank: &nbsp;<span class="span-alexa"> {{ optional($post->attributes_relation)->alexa_country_rank
                                        ?? ""
                                        }}</span>
                                </p>
                                <hr>
                        ...
                        <div class=" col-lg-4 col-md-6 col-12">
                            <div class="state-sec">
                                ...
                                <p class="p-alexa"><span><i class="fa fa-check blog-bgstate" aria-hidden="true"></i></span>&nbsp;language: &nbsp;<span class="span-alexa">{{ optional($post->seo_analyzers_relation)->language ?? ""
                                        }}</span>
                                </p>
                                <hr>
                                <p class="p-alexa"><span><i class="fa fa-check blog-bgstate" aria-hidden="true"></i></span>&nbsp; Response Time: &nbsp;<span class="span-alexa">{{ optional($post->seo_analyzers_relation)->loadtime ?? ""
                                        }}</span>
                                </p>
                                <hr>
                                <p class="p-alexa"><span><i class="fa fa-check blog-bgstate" aria-hidden="true"></i></span>&nbsp; SSL: &nbsp;<span class="span-alexa">{{
                                        ( optional($post->Ssl_Details_relation)->isValid ==1) ? "Enable" : "Disable" ??
                                        ""
                                        }}</span> </p>
                                <hr>
                                <p class="p-alexa"><span><i class="fa fa-check blog-bgstate" aria-hidden="true"></i></span>&nbsp; Status: &nbsp;<span class="span-alexa">up</span> </p>
                                <hr>
                            </div>
                        </div>
                        <div class=" col-lg-4 col-md-6 col-12">
                            <div class="state-sec">
                                ...
                                <p class="p-alexa"><span><i class="fa fa-check blog-bgstate" aria-hidden="true"></i></span>&nbsp;Word Count &nbsp;<span class="span-alexa">{{ optional($post->seo_analyzers_relation)->word_count
                                        ?? "" }}</span> </p>
                                <hr>
                                <p class="p-alexa"><span><i class="fa fa-check blog-bgstate" aria-hidden="true"></i></span>&nbsp;Links &nbsp;<span class="span-alexa">{{
                                        optional($post->seo_analyzers_relation)->links['external'] ?? ""}}</span>
                                </p>
                                <hr>
                                <p class="p-alexa"><span><i class="fa fa-check blog-bgstate" aria-hidden="true"></i></span>&nbsp; ratio &nbsp;<span class="span-alexa">{{
            ...
            <div class="row">
                <div class="col-12 col-md-10">
                    <div class="middle-sec mt-4 mb-4">
                        <h2>Found {{ $alter_count }} Hospital Portals like {{ ucfirst($post->slug) }}
                        </h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-3">
                        <div class="cc">
                            ...
                            <img class="img-fluid  mt-2" src="https://s3.us-west-1.wasabisys.com/{{ config('filesystems.disks.wasabi.bucket') }}/scrape/thumbnail/{{ $alternative_data->thumbnail }}">

                            @else
                            <img class="img-fluid  mt-2" src="https://s3.us-west-1.wasabisys.com/{{ config('filesystems.disks.wasabi.bucket') }}/scrape/thumbnail/noimage.png">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-5">
                        <h2>
                            <img class="img-fluid  mt-2" src="https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://{{ $alternative_data->slug }}&size=32">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <a href="{{ route('post.show',['post'=>$alternative->slug]) }}" class="btn btn-success btn-product">Hospital Like {{
